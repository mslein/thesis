...
label.df <- data.frame(covariates = c("flux_range", "flux_range:mean_constant_temp", "org_level"),
                       value = c(0.3, -0.01, -0.69))

ggplot(data=full_model_coefficients, aes(x = reorder(covariates, value),
             y = value,
             fill = value > 0)) +
