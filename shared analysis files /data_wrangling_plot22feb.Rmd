...
#load data
dat_MA_0<- read_csv("metafor7march.csv")
regions <- read_csv("gbif_regiondata.csv")
```
...
## Question: How does fluctuation amplitude affect response variables?

### Figure 3.
```{r, message=FALSE}
# boxplots of how fluctuation range influences SMD
ggplot(normalized, aes(x=as.factor(flux_range), y=yi))+
  geom_boxplot()+
  theme_bw()+
...
## Question how does mean temperature affect response variables?

### Figure 7.
```{r, message=FALSE}
# boxplots of how mean temperature influences SMD
ggplot(normalized, aes(x=as.factor(mean_temp_constant), y=yi))+
  geom_boxplot()+
  theme_bw()+
...
## Question: How does genus affect response?
...
fig11 <- rma.mv(yi, vi, data=dat_MA_ES, mods = ~genus,
               random = ~1 | experiment_id/ study_id,
                 method="REML") 
fig11
...
## Question how does scale (life or org level) affect response?
### Figure 11. 
...
## Question: How does response variable affect response?
### Figure 14.
```{r}
