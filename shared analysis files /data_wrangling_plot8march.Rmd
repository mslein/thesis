...
count(dat_MA_0, study_id, genus, species, mean_temp_constant, min_temp, max_temp)
```
...
```{r}
#contour plot with flux_range on the x axis, mean temp of the y axis and colored by yi
fig <- plot_ly(
  x = normalized$flux_range, 
  y = normalized$mean_temp_constant, 
  z = normalized$yi, 
  type = "contour")
fig
