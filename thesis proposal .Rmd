...
2. Discuss how to design proper search term parameters that provides big picture but managable study count
...
# Methods
1. I will conduct a series of ISI literature searches to get a hollistic set of studies referencing environmental variation with selected keywords. I will then select studis based on a stricy set of criteria and enter those studies into a spreadsheet, recording relevant information (study organism, biological organization level, variation type, response variable, ). 
...
2. I will then synthesize the patterns across studies to address my main objectives. This will culminate in written document summarizing that language used in different sub disciplines as well as the similarities and differences in environmental variability. 
