...
spectral_red <- data.frame(specx = mspect$freq/delta, specy = specy)
 #then make a plot with these calcs on the x and y  
...
#attempting to make figure plot
plot_grid(red_series, spec_red, white_series, spec_white,
          diurnal_series, spec_diurn,
