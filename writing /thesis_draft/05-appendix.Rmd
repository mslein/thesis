...
table4 <- data.frame(Species = c("Drosophila melanogaster", "Leptopilina boulardi", 
                         ...
                         "Trachemys scripta", "Esteya vermicola"), 
                 Topt = c("24-26.6 C", "25 C", "37.97 +/- 0.64", "< 30 C", "30 C", "30-33 C",
                          "33 C", " </= 30 C", "26 C", "33 C", "30-35 C", "37 C, 35-36 C",
                          "35-36 C", "32-33 C", "32-33 C", "26 C"), 
                 `Reference` = c("Klepsatel 2013, David 1988", "De lava et al 2016", 
                                 ...
                                 "Dang et al 2019", "Wang et al 2015"))
kable(table4, "latex", booktabs = T, 
      col.names = c("Species", "Topt", "Reference"), escape = F, caption = "TPC metrics extracted from additional papers to collect thermal history data for each species in the meta analysis (missing data on species X. arvicola, used in Garcia-Ruiz et al 2011)", caption.short ="Thermal stress data by species") %>%
