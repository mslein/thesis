...
kable(table4, "latex", booktabs = T, 
      col.names = c("Species", "Topt (°C)", "Reference"), escape = F, caption = "TPC metrics extracted from additional papers to collect thermal history data for each species in the meta-analysis (missing data on species X. arvicola, used in Garcia-Ruiz et al 2011)", caption.short ="Thermal stress data by species") %>%
